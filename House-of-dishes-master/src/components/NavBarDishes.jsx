    ...
    <>
      <div className='py-10 bg-[#ADD8E6]'>
        <div className='flex justify-center gap-6 font-medium pt-5'>
          ...
          <Link to='/Luxury-Dishes' className='bg-gradient-to-tr from-cyan-400 to-blue-500 text-white p-2 rounded-full px-5' onClick={() => window.scrollTo(0, 0)}>Luxury Dishes</Link>
